    ...
    <div>
      ...
      {!showPayment ? (
        ...
        <>
          ...
          <div className="border border-border rounded-xl p-6 mb-6 animate-fade-in">
            <p className="font-display font-bold text-[0.8rem] uppercase tracking-wide text-mid-gray mb-4">
